...
<div class="hidden lg:flex items-center space-x-4">
    <div class="relative group">
        <button class="flex items-center space-x-3 btn-glass px-4 py-2 rounded-xl">
            ...
            <span class="text-sm font-medium text-gray-300">{{ 'Guest' }}</span>
        ...
        <div
            ...
            <div class="p-4 border-b border-white/10">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-white">{{ 'Guest User' }}</h4>
                        <p class="text-sm text-gray-400">{{ 'guest@example.com' }}</p>
                    </div>
                </div>
            </div>
            <div class="py-2">
