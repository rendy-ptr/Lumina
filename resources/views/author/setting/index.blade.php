        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div class="glass-strong rounded-3xl border border-white/10 p-6 space-y-6 xl:col-span-2">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div class="rounded-2xl border border-emerald-400/30 bg-emerald-400/10 px-4 py-2 text-xs text-emerald-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-base font-semibold text-white tracking-widest">{{ $maskedPassword }}</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-start gap-2 text-xs text-white/50">
                            ...
                            <span>Last updated {{ $accountUpdatedAt }}. Refresh your password regularly for extra safety.</span>
                        </div>
                        <div class="flex items-center justify-between">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-white/10">
                    ...
                    <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                        ...
                        <p class="text-sm font-medium text-white">{{ ucfirst($user?->role ?? 'author') }}</p>
                    </div>
                </div>
            </div>
